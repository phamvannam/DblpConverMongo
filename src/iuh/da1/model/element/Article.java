...
public class Article implements Element
{
	...
	private String key,reviewid,rating,mdate ;
	public Article() {
	...
	public String toString() {
		return "Article [author=" + author + ", editor=" + editor + ", title="
				+ title + ", booktitle=" + booktitle + ", pages=" + pages
				+ ", year=" + year + ", address=" + address + ", journal="
				+ journal + ", volume=" + volume + ", number=" + number
				+ ", month=" + month + ", url=" + url + ", ee=" + ee
				...
				+ key + ", reviewid=" + reviewid + ", rating=" + rating
				+ ", mdate=" + mdate + "]";
	}
